...
/**
 * corbaBanque/IBanqueRemoteHelper.java . Generated by the IDL-to-Java compiler
...
abstract public class IBanqueRemoteHelper {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			__typeCode = org.omg.CORBA.ORB.init().create_interface_tc(corbaBanque.IBanqueRemoteHelper.id(),
					"IBanqueRemote");
		}
		return __typeCode;
	}
